...
@section('content')
  ...
  <div class="content-header">
    ...
    <!-- /.content-header -->
  {!!Form::open(['url'=>'admin/report/supplier/', 'id' => 'orderForm' ,'name' => 'orderForm' ,'enctype' => 'multipart/form-data', 'method'=>'get']) !!} 
    <!-- Main content -->
  <section class="content">
    <div class="container-fluid">
      <div class="box-main">
        <div class="box-main-top flex-content">
          <div class="box-main-title">Registered Business/Supplier</div>
            ...
            <div class="col-md-12 col-xl-12">
              <form>
                ...
                <div class="d-flex flex-row justify-content-end">
                  <span class="mr-2">
                    <i class="fas fa-square text-primary"></i> Business Supplier
                  </span>

                  <span>
                    <i class="fas fa-square text-red"></i> Member Supplier
                  </span>
                </div>
              </div>
              </form>
 ...
 $(function () {
  ...
  var visitorsChart  = new Chart($visitorsChart, {
    data   : {
      ...
      {
          type                : 'line',
          data                : <?php echo json_encode($MembercharArr1) ;?>,
          backgroundColor     : 'tansparent',
          borderColor         : '#ff0a0a',
          pointBorderColor    : '#ff0a0a',
          pointBackgroundColor: '#ff0a0a',
          fill                : false
