  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          {!!Form::open(['url'=>'admin/supplier/view',  'name' => 'orderForm' ,'enctype' => 'multipart/form-data', 'method'=>'get','onsubmit'=>"return validateForm()"]) !!}
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-8 col-12">
                <input type="text" name="to_date" class="form-control" id="to_date" readonly="readonly"value="{{Request::get('to_date')}}"  readonly="readonly" placeholder="MM-DD-YYYY">
                <i class="fa fa-calendar input-icon" aria-hidden="true"></i>
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-8 col-12">
                ...
                <a href="{{URL('admin/supplier/view')}}"> <button type="button" class="btn btn-primary">Reset</button></a>
              </div>
            </div>
          </div>
        {!!Form::close()!!}    
