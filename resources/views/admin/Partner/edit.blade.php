    ...
    <div class="container-fluid">
      <div class="box-main">
        <div class="box-main-top">
          <div class="box-main-title">Edit Partners</div>
              ...
              {!!Form::open(['url'=>'admin/partner/edit-save','name' => 'orderForm' , 'enctype' => 'multipart/form-data', 'method'=>'post' ,'onsubmit'=>"return validateForm()"]) !!} 
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9 col-12">
                     <!--  <input type="text" name="" class="form-control" placeholder="Enter Trade Name"> -->
                      {!!Form::text('name',$Partner->name,['class' => 'form-control','placeholder' => 'Enter Partner Name','required' => 'required']) !!}
                    </div>
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-md-9 col-12">
                     <!--  <input type="text" name="" class="form-control" placeholder="Enter Trade Name"> -->
                      {!!Form::textarea('desc',$Partner->desc,['class' => 'form-control','placeholder' => 'Enter Description','required' => 'required','cols'=>"50",'rows'=>"5",]) !!}
                    </div>
                  </div>
                </div>
                 <div class="form-group">
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-md-9 col-12">
                     <!--  <input type="text" name="" class="form-control" placeholder="Enter Trade Name"> -->
                      {!!Form::text('type_text',$Partner->type_text,['class' => 'form-control','placeholder' => 'Enter type','required' => 'required']) !!}
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-md-9 col-12">
                     <!--  <input type="text" name="location" class="form-control" placeholder="Enter Trade Name"> -->
                      {!!Form::text('location',$Partner->location,['class' => 'form-control','placeholder' => 'Enter Location','required' => 'required']) !!}
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="input-group date" id="opening" data-target-input="nearest">
                       ...
                       {!!Form::text('opening',$Partner->opening,['class' => 'form-control datetimepicker-input','data-target' => '#opening','required' => 'required']) !!}
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="input-group date" id="closing" data-target-input="nearest">
                       ...
                       {!!Form::text('closing',$Partner->closing,['class' => 'form-control datetimepicker-input','data-target' => '#closing','required' => 'required']) !!}
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-md-9 col-12">
                      <label class="switch">
                            <input id="toggle" value="1" name="toggle" type="checkbox" {{ $Partner->is_premium === 1 ? 'checked' : '' }}>
                ...
                <div class="form-group" id="promocodediv" >
                  <div class="row">
                    ...
                    <div class="col-md-9 col-12">
                     <!--  <input type="text" name="" class="form-control" placeholder="Enter Trade Name"> -->
                      {!!Form::text('promo_code',$Partner->promo_code,['class' => 'form-control','placeholder' => 'Enter Promo Code']) !!}
                    </div>
                  </div>
                </div>
                <div class="form-group"  id="promodetaildiv">
                  <div class="row">
                    ...
                    <div class="col-md-9 col-12">
                     <!--  <input type="text" name="" class="form-control" placeholder="Enter Trade Name"> -->
                      {!!Form::text('promo_detail',$Partner->promo_detail,['class' => 'form-control','placeholder' => 'Enter Promo Detail']) !!}
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9 col-12">
                      <label class="switch">
                           ...
                           <input id="toggle2" value="1" name="toggle2" type="checkbox" {{ $Partner->is_discount === 1 ? 'checked' : '' }}>
                        <span class="switchslider round"></span>
                      </label>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9 col-12">
                      <label class="switch">
                           ...
                           <input id="toggle3" value="1" name="toggle3" type="checkbox" {{ $Partner->is_recommend === 1 ? 'checked' : '' }}>
                        <span class="switchslider round"></span>
                      </label>
