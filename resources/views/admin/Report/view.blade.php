...
@section('content')
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Report Post </h1>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  </div>
    ...
    <div class="container-fluid">
      <div class="box-main">
        <div class="box-main-top">
          <div class="box-main-title">Report Post List</div>
              ...
              <table class="table table-bordered admin-table dataTable"  id="example2" >
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{$chip->report_type}}</td>
                    <td>
                      
                        <a  onClick="DeleteTrade({{$chip->post_id}})" style="cursor: pointer"> <i class="fa fa-ban aria-hidden="true""></i>
                                </a>          
                    </td>
                  </tr>
                  @endforeach()
...
{ 
  $("#LoadingProgress").fadeIn('fast');
    if (confirm('Are you sure you want to delete this Post?')) {
      ...
      success: function( data, textStatus, jqXHR ) {
        if(data == 0){
          alert('Sorry, this Post cannot be deleted.');
        }else{
         window.location.reload();
         $("#LoadingProgress").fadeOut('fast');
        }
