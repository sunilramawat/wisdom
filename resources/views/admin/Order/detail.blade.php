      ...
      <div class="box-main">
        <div class="box-main-top">
              ...
              <div class="title">
                ...
                <span class="dark-text">#{{$Supplier->order_code}}</span>
                    ...
                    @elseif($Supplier->order_status == 5)
                       <span class="title-label-red">Returned</span>
          ...
          <div class="box-main-top-right">
            <a href="{{URL('admin/order/view')}}"><button type="button" class="btn btn-primary">Back</button></a></div>
          </div>
                ...
                <form>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-8 col-12">
                        <div class="request-detail-text">
                          {{date('M d,Y',strtotime($Supplier->order_date))}}
                         </div>
                  ...
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="col-md-8 col-12">
                        <div class="request-detail-text pl-9"><span class="currency-sign">$</span> {{$Supplier->total_amount}}</div>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
          ...
          <div class="box-main-top">
            <div class="box-main-title">Order Items</div>
            <!--   <div class="box-main-top-right">
