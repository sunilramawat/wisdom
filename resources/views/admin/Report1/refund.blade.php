    ...
    <div class="container-fluid">
      <div class="box-main">
        <div class="box-main-top">
          <div class="box-main-title">Refund Requests</div>
              ...
              <table class="table table-bordered admin-table dataTable"  id="example2" >
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $chip->refund_date? date('M d,Y',strtotime($chip->refund_date)):'-'}}</td>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
         {!!Form::open(['url'=>'admin/report/refund',  'name' => 'orderForm' ,'enctype' => 'multipart/form-data', 'method'=>'get','onsubmit'=>"return validateForm()"]) !!} 
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-8 col-12">
                <input type="text" name="from_date" class="form-control" id="from_date" placeholder="MM-DD-YYYY" value="{{Request::get('from_date')?Request::get('from_date'):date('m/d/Y')}}" readonly="readonly">
