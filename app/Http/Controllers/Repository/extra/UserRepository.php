...
Class UserRepository extends User{
	...
	public function register($data){
		...
		if(!isset($data['id'])){
			...
			$create_user->photo = @$data['photo']?$data['photo']:$create_user['phone'];
	...
	public function getuserById($data){
		...
		$follower_count  = $this->follower_count($use['id']);
	...
	public function delete_post($data){
		...
		$deleteanswerq =  Post::where('repost_id',$data['post_id'])->delete();	


		$deletecomment =  Comment::where('post_id',$data['post_id'])->delete();	
		$deletelike =  Like::where('post_id',$data['post_id'])->delete();	
		$deletefav =  Favourite::where('post_id',$data['post_id'])->delete();	
		//$deletecomment =  CommentLike::where('post_id',$data['post_id'])->delete();	
		return 1;
	}
	...
	public function get_media_list($userid){
		$photoData = DB::table('photos')
            ->where('p_u_id','=',$userid)
            ->where('status','=',1)
            ->get();
	...
	public function userList($data){
		...
		if(isset($name)){
			...
			$query =$query->where('first_name','=',@$name);
		}
	...
	public function follow($arg,$userId){
		$checklfollow = Follow::where('follow_by', $userId)->where('user_id', $arg['user_id'])->first();
