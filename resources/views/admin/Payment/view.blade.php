...
@section('content')
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Manage Payment </h1>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  </div>
    ...
    <div class="container-fluid">
      <div class="box-main">
        <div class="box-main-top">
          <div class="box-main-title">Payment List</div>
            ...
            <div class="table-responsive">
              <table class="table table-bordered admin-table dataTable"  id="example2" >
                ...
                <tbody>
                  ...
                  <tr>
                    <td>{{$no+1}}</td>
                    <td> <a href="{{URL('admin/payment/detail')}}/{{$chip->id}}">{{$chip->order_code}}</a></td>
                    <td>{{$chip->supplier_name}}</td>
                    <td>${{$chip->total_amount}}</td>
                    <td>{{date('M d,Y',strtotime($chip->order_date)).' | '.$chip->order_time}}</td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
         ...
         {!!Form::open(['url'=>'admin/payment/view',  'name' => 'orderForm' ,'enctype' => 'multipart/form-data', 'method'=>'get','onsubmit'=>"return validateForm()"]) !!} 
           <div class="form-group">
            <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-8 col-12">
                <button type="submit" class="btn btn-primary">Apply</button>
                 <a href="{{URL('admin/payment/view')}}"> <button type="button" class="btn btn-primary">Reset</button></a>
              </div>
            </div>
          </div>
        {!!Form::close()!!}    
