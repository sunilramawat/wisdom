              ...
              <form>
                  ...
                  <div class="row align-items-end">
                    ...
                    <div class="col-md-8 col-12">
                      <div class="manage-supplierdetail-profile">
                           @if($Supplier->business_logo_url !=  '' )         
                              <img id="preview" src="{{$Supplier->business_logo_url}}" />
                          @else
                            <img id="preview" src="{{URL('public/admin/dist/img/avatar.png')}}" />  
                          @endif
                       </div>
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-md-8 col-12">
                      ...
                      {!!Form::text('email',$Supplier->email,['class' => 'form-control','placeholder'=>'Email Address','readonly']) !!}
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-md-8 col-12">
                     	@php
                     	$phone = '+'.$Supplier->phone_code.' '.$Supplier->phone_number;
                     	@endphp
                       {!!Form::text('phone_number',$phone,['class' => 'form-control','placeholder'=>'Phone Number']) !!}
                    </div>
                  </div>
                </div>
                <div class="form-group">
