    ...
    <div class="container-fluid">
      <div class="box-main">
        <div class="box-main-top">
          <div class="box-main-title">Orders Cancelled</div>
              ...
              <table class="table table-bordered admin-table dataTable"  id="example2" >
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{date('M d,Y',strtotime($chip->order_cancel_date))}}</td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
         ...
         {!!Form::open(['url'=>'admin/report/cancel',  'name' => 'orderForm' ,'enctype' => 'multipart/form-data', 'method'=>'get','onsubmit'=>"return validateForm()"]) !!} 
           <div class="form-group">
            <div class="row">
             ...
             <input type="hidden" id="order_status_id" name="">
              <div class="col-md-8 col-12">
                <select class="form-control" name="order_status" id="order_status">
                  ...
                  <option value="0" {{Request::get('order_status') != '' ? 'selected' : '' }}>Read to Dispatch</option>
                  <option value="1" {{Request::get('order_status') == 1 ? 'selected' : '' }}>Shipped</option>
                  <option value="2" {{Request::get('order_status') == 2 ? 'selected' : '' }}>Delivered</option>
                  <option value="3" {{Request::get('order_status') == 3 ? 'selected' : '' }}>Returned</option>
                  <option value="4" {{Request::get('order_status') == 4 ? 'selected' : '' }}>Payment Pending</option>
                  <option value="5" {{Request::get('order_status') == 5 ? 'selected' : '' }}>Payment Fail</option>
                </select>
              </div>
            </div>
          </div>  -->
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-8 col-12">
                ...
                <a href="{{URL('admin/report/cancel')}}"> <button type="button" class="btn btn-primary">Reset</button></a>
              </div>
            </div>
          </div>
        {!!Form::close()!!}    
