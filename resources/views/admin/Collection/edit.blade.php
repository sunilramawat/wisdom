    ...
    <div class="container-fluid">
      <div class="box-main">
        <div class="box-main-top">
          <div class="box-main-title">Edit Knowledge</div>
        ...
        <div class="box-main-content mb-3">
          <div class="row">
            ...
            <div class="col-md-12 col-xl-6">
              {!!Form::open(['url'=>'admin/collection/edit-save',  'name' => 'orderForm', 'enctype' => 'multipart/form-data', 'method'=>'post','onsubmit'=>"return validateForm()"]) !!}   
                 ...
                 <div class="form-group">
                  <div class="row">
                    ...
                    <div class="manage-supplierdetail-profile">
                      @if($Partner->photo !=  '' )    
                      <img id="preview" src="{{$Partner->photo}}" />
                    @endif</div>
            ...
            <div class="form-group"  >
              <div class="row">
                ...
                <select name="category" id="category" class="form-control">
                          @foreach($category as $key => $vale)
                           <option value="{{$key}}" {{$key == $Partner->category ? 'selected' : ''}}>{{$vale}}</option>
              ...
              <div class="row">
                ...
                <div class="col-md-8 col-12">
                   <!--  <input type="text" name="" class="form-control" placeholder="Enter Trade Name"> -->
                    {!!Form::text('title',$Partner->title,['class' => 'form-control','placeholder' => 'Title','required' => 'required','maxlength' => 255]) !!}
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-8 col-12">
                 <!--  <input type="text" name="" class="form-control" placeholder="Enter Trade Name"> -->
                  {!!Form::textarea('desc',$Partner->desc,['class' => 'form-control','placeholder' => 'Enter Description','required' => 'required','cols'=>"50",'rows'=>"5",'maxlength' => 255]) !!}
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-8 col-12">
                   <!--  <input type="text" name="" class="form-control" placeholder="Enter Trade Name"> -->
                    {!!Form::text('author',$Partner->author,['class' => 'form-control','placeholder' => 'Author','required' => 'required','maxlength' => 255]) !!}
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-8 col-12">
                   <!--  <input type="text" name="" class="form-control" placeholder="Enter Trade Name"> -->
                    {!!Form::text('amazon_link',$Partner->amazon_link,['class' => 'form-control','placeholder' => 'Amazon Link','maxlength' => 255]) !!}
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-8 col-12">
                   <!--  <input type="text" name="" class="form-control" placeholder="Enter Trade Name"> -->
                    {!!Form::text('ebay_link',$Partner->ebay_link,['class' => 'form-control','placeholder' => 'Ebay Link','maxlength' => 255]) !!}
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-8 col-12">
                   <!--  <input type="text" name="" class="form-control" placeholder="Enter Trade Name"> -->
                    {!!Form::text('wordery',$Partner->wordery,['class' => 'form-control','placeholder' => 'Wordery Link','maxlength' => 255]) !!}
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-8 col-12">
                   <!--  <input type="text" name="" class="form-control" placeholder="Enter Trade Name"> -->
                    {!!Form::text('other_link1',$Partner->other_link1,['class' => 'form-control','placeholder' => 'Other Link','maxlength' => 255]) !!}
            ...
            <div class="form-group">
              <div class="row">
                ...
                <div class="col-md-8 col-12">
                   <!--  <input type="text" name="" class="form-control" placeholder="Enter Trade Name"> -->
                    {!!Form::text('other_link2',$Partner->other_link2,['class' => 'form-control','placeholder' => 'Other Link','maxlength' => 255]) !!}
